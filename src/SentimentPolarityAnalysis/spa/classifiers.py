...
class DictClassifier:
    def __init__(self):
        self.__root_filepath = "D:/ProjectPYTHON/DouyuDanmuV1/src/SentimentPolarityAnalysis/spa/f_dict/"

        jieba.load_userdict("D:/ProjectPYTHON/DouyuDanmuV1/src/SentimentPolarityAnalysis/spa/f_dict/user.dict")  # 准备分词词典
